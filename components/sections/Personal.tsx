    ...
    <Section index={PortfolioState.PERSONAL}>
        <div className="text-center max-w-4xl mx-auto h-full flex flex-col">
            ...
            <ScrollableContent className="pb-10">
                {/* Unified box */}
                <div className="bg-white/60 dark:bg-black/60 backdrop-blur-md p-6 md:p-8 rounded-2xl border border-slate-200 dark:border-white/10 relative overflow-hidden text-left transition-colors duration-500">
