                            ...
                            return (
                                <a
                                    ...
                                    className={`
                                        ...
                                        hover:z-50 hover:shadow-2xl dark:hover:shadow-[0_20px_40px_rgba(13,148,136,0.25)]
                                        ...
                                        <div className={`flex-shrink-0 ${isRightColumn ? 'md:group-hover:order-2' : 'md:group-hover:order-1'}`}>
                                            ...
                                            <div className="p-3 md:p-4">
                                                ...
                                                <div className="flex items-center gap-2 mb-2">
                                                    ...
                                                    <span className="text-[10px] bg-slate-100 dark:bg-white/5 px-2 py-0.5 rounded-full text-teal-600 dark:text-teal-300 border border-slate-200 dark:border-white/10 group-hover:border-teal-500/30 group-hover:text-teal-500 dark:group-hover:text-teal-300 transition-colors">{post.category}</span>
                                                </div>
