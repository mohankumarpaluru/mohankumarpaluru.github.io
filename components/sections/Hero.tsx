...
export const Hero: React.FC = () => {
  ...
  return (
    <Section index={PortfolioState.HERO}>
        ...
        <>
          ...
          <div
            ...
            style={{
              ...
              borderRadius: '50%',
              filter: 'blur(18px)',
              background: 'var(--hero-scrim-desktop)',
              opacity: 0.92,
            }}
          />
      ...
      <div className="text-center md:text-left py-4 md:py-10 h-full flex flex-col justify-center relative z-20 pointer-events-auto">
        ...
        <h1 className="text-5xl md:text-8xl font-bold tracking-tighter mb-4 md:mb-6 leading-tight max-w-[20ch] md:max-w-none mx-auto md:mx-0 text-balance dark:shadow-none shadow-[0_0_0.6px_rgba(15,23,42,0.35),0_2px_10px_rgba(255,255,255,0.65)]">
          <span className="text-slate-800 dark:text-white transition-colors antialiased">{firstName}</span> <br className="md:hidden" />
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#2563eb] to-[#0891b2] dark:from-blue-200 dark:via-blue-300 dark:to-cyan-300 saturate-[0.95] contrast-[0.98] dark:saturate-100 dark:contrast-100 dark:filter-none filter drop-shadow-[0_2px_14px_rgba(37,99,235,0.12)] dark:drop-shadow-none">{lastName}</span>
        </h1>

        <div className="text-lg md:text-2xl font-light border-l-2 border-blue-500/30 dark:border-blue-500/50 pl-4 md:pl-6 space-y-2 transition-colors">
        ...
        <div className="mt-8 md:mt-12 animate-bounce opacity-50 dark:opacity-60 text-[10px] md:text-xs font-mono tracking-[0.15em] text-blue-600 dark:text-blue-300 uppercase">
          {sectionData.tagline}
        </div>
      </div>
    </Section>
