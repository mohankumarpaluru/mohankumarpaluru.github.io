                            ...
                            {featuredProjects[0] && (
                                <div className="md:col-span-4 lg:col-span-6 md:row-span-2">
                                    <GlowCard
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="group relative h-full min-h-[200px] md:min-h-[300px] flex flex-col cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_32px_rgba(8,12,24,0.12)] dark:hover:shadow-[0_16px_32px_rgba(0,0,0,0.45),0_0_0_1px_rgba(120,100,255,0.18)] hover:border-[#5c4cff]/25"
                                    >
                                        <div className={cardScrim}></div>

                                        <div className="relative z-10 w-full h-28 md:h-40 bg-gradient-to-br from-blue-100 via-purple-50 to-pink-100 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-pink-900/20 overflow-hidden">
                                        ...
                                        <div className="relative z-10 p-3 md:p-4 flex flex-col flex-1">
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                <ExternalLink
                                                    size={18}
                                                    className="shrink-0 text-slate-500 dark:text-slate-400 group-hover:text-purple-500 dark:group-hover:text-purple-400 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all"
                                                />
                                            </div>
                                            ...
                                            <div className="flex flex-wrap gap-1.5 mt-auto">
                                                {featuredProjects[0].tags.map(tag => (
                                                    <span key={tag} className="text-[10px] font-mono text-[#483ad2]/92 dark:text-indigo-300 bg-[#5c4cff]/10 dark:bg-black/30 px-2 py-0.5 rounded border border-[#5c4cff]/[0.18] dark:border-white/10 group-hover:border-indigo-500/30 transition-colors">#{tag}</span>
                                                ))}
                                            </div>
                                        </div>
                                    </GlowCard>
                            ...
                            {featuredProjects[1] && (
                                <div className="md:col-span-2 lg:col-span-3 md:row-span-1">
                                    <GlowCard
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="group relative h-full min-h-[170px] md:min-h-[140px] flex flex-col cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_32px_rgba(8,12,24,0.12)] dark:hover:shadow-[0_16px_32px_rgba(0,0,0,0.45)] hover:border-[#5c4cff]/25"
                                    >
                                        <div className={cardScrim}></div>
                                        ...
                                        <div className="relative z-10 p-3 flex flex-col flex-1">
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                <ExternalLink size={14} className="shrink-0 text-slate-500 dark:text-slate-400 group-hover:text-purple-500 dark:group-hover:text-purple-400 transition-all" />
                                            </div>
                                            ...
                                            <div className="flex flex-wrap gap-1 mt-auto">
                                                {featuredProjects[1].tags.map(tag => (
                                                    <span key={tag} className="text-[9px] font-mono text-[#483ad2]/92 dark:text-indigo-300 bg-[#5c4cff]/10 dark:bg-black/30 px-1.5 py-0.5 rounded border border-[#5c4cff]/[0.18] dark:border-white/10">#{tag}</span>
                                                ))}
                                            </div>
                                        </div>
                                    </GlowCard>
                                    ...
                                    >
                                        ...
                                        <div className="relative z-10 p-3 flex flex-col h-full">
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                <ExternalLink size={12} className="shrink-0 text-slate-400 dark:text-slate-500 group-hover:text-purple-500 dark:group-hover:text-purple-400 transition-all" />
                                            </div>
                            ...
                            {featuredProjects[2] && (
                                <div className="md:col-span-3 lg:col-span-4">
                                    <GlowCard
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="group relative h-full min-h-[160px] md:min-h-[140px] flex flex-col cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_32px_rgba(8,12,24,0.12)] dark:hover:shadow-[0_16px_32px_rgba(0,0,0,0.45)] hover:border-[#5c4cff]/25"
                                    >
                                        <div className={cardScrim}></div>

                                        <div className="relative z-10 w-full h-20 md:h-24 bg-gradient-to-br from-orange-100 to-pink-100 dark:from-orange-900/20 dark:to-pink-900/20 overflow-hidden">
